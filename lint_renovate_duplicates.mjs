...
//
// Example output:
//   [INFO] Linting 3 files: default.json, rules-actions.json, rules-javascript.json5
...
//     [MULTI] github-actions (covered by 3 rules): rules-actions.json[0], rules-actions.json[1], rules-actions.json[2]
