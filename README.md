...
```
- **Monthly releases** (month segment reflects the release month) - scheduled on the 1st of each month when updates are available, plus out-of-band patches when urgent fixes land.
